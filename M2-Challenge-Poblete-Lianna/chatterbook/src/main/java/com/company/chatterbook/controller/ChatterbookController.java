...
public class ChatterbookController {
    ...
    public User getUserByName(@PathVariable String name) {
        ...
        for(User user: userList){
            if(user.getName().equals(name)){ selectedUser = user; }
        }
    ...
    public List<ChatterPost> getChatterPostsByName(@PathVariable String name) { return getUserByName(name).getChatterPosts(); }
}
